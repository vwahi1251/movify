...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'hentry' ); cryout_schema_microdata( 'blogpost' ); ?>>
	...
	<div class="article-inner">
		...
		if ( $fluidas['fluida_excerptarchive'] == "full" ) { $mode = 'content'; }
		if ( is_sticky() && $fluidas['fluida_excerptsticky'] == "full" ) { $mode = 'content'; }
		if ( $fluidas['fluida_excerpthome'] == "full" && ! is_archive() && ! is_search() ) { $mode = 'content'; }
