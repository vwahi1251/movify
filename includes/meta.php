...
function fluida_layout_meta_box() {
	...
	<p>
    	...
    	<label id="cryout_layout_default">
            ...
            <span><img src="<?php echo get_template_directory_uri() ?>/admin/images/0def.png" alt="<?php _e( 'Default Theme Layout', 'fluida' ); ?>" title="<?php _e( 'Default Theme Layout', 'fluida' ); ?>" /></span>
        </label>
	</p>
	<?php
} //fluida_layout_meta_box()
