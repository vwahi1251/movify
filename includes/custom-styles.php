...
#access i.search-icon { font-weight:2  ?>; }
...
.comments-link a:hover 						{ color: black;}
...
select, input[type], textarea 				{ color:#555;}
...
select, input[type], textarea
											{ order-color: <?php echo esc_html( cryout_hexdiff( $fluida_contentbackground, 22 ) ) ?>; }
